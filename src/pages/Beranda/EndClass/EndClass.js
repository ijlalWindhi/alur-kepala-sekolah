...
export default class EndClass extends React.Component {
  constructor() {
    super();
    this.state = {
      // call variable
          ...
          <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-1 mt-8">
            <div class="col-span-2 ml-14">
              ...
              <div className="mt-4 text-base font-normal text-gray-400">
                <a href="/beranda" className="mr-5">Semua</a>
                <a href="/newclass" className="mr-5">Terbaru</a>
                <a href="/endclass" className="mr-5 text-black">Selesai</a>
              ...
              <div className="mt-5">
                <div className="bg-white p-4 rounded-3xl grid grid-cols-4">
                  ...
                  <div className="col-span-3 py-2 px-8">
                    ...
                    <span className="p-2 rounded-lg bg-teal-100 text-teal-400 text-sm font-medium">Rekayasa Perangkat Lunak</span>
                    <div className="grid grid-cols-4 mt-6">
                        <div className="col-span-2">
                            <h6 className="text-sm font-medium">39% Compolete</h6>
                            <div class="w-full bg-teal-100 rounded-full h-2.5 dark:bg-gray-700 mr-4 mt-1">
                                <div class="bg-teal-400 h-2.5 rounded-full" style={{width: '45%'}}></div>
                            </div>
                        </div>
                        <div></div>
