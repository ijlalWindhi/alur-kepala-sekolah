            ...
            <> < LayoutSidebar > <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-1 mt-8">
                <div class="col-span-2 ml-14 mt-3">
                    <div className="card rounded-lg p-6">
                        <h4 className="text-3xl font-semibold mb-5">Tontonan Original Platform SMK TKJ</h4>
                ...
                <div>
                    ...
                    <div className="pl-32 mt-12">
                        ...
                        <div className="mt-6">
                            <Link to="/acara" className="py-3 pl-5 pr-32 text-white bg-red-500 rounded-2xl">
