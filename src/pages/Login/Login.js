              ...
              <div className="flex w-1/2 justify-center items-center">
                <div>
                  ...
                  <form action="#" method="POST" className="mt-8">
                    ...
                    <button type="submit" className="justify-center mt-8 w-96 py-4 px-6 border border-transparent rounded-full text-lg font-medium text-white bg-red-500 ">Login</button>
                  </form>
