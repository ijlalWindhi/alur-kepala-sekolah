    ...
    return (
      <>
        <div className="bg-landing">
          ...
          <div className="grid grid-cols-2 py-5 px-5 pt-32 pb-32 ">
            <div className="pt-10 px-20">
              <h1 className="text-4xl font-semibold text-white text-2xl">
                Selamat Datang di
                <br />
                Platform SMK TKJ
              </h1>
              ...
              <button className="bg-white rounded-full py-3 px-8 text-red-600 mt-8 font-medium" href="#tentang">
                #Caritau
              </button>
            </div>
          ...
          <div className="grid grid-cols-2 py-7 px-7 pt-32 pb-32 " id="tentang">
            <div className="p-20">
        ...
        <div className="py-5 px-5 text-center mb-20 pt-16 pb-16">
