                            ...
                            <div className="">
                                <div className="card  rounded-3xl bg-white">
                                    ...
                                    <div className="card-body p-6 relative">
                                        <div className="mt-4">
                                            <div className="mb-12">
                                                <Link to="/detailKelasKS" className="text-lg font-normal mr-6 text-gray-300">Aktivitas</Link>
                                                <Link to="/pesertaKS" className="text-lg font-normal border-b-2 border-red-600">Peserta</Link>
                                            </div>
                                        </div>
