...
export default class EndClassKS extends React.Component {
  constructor() {
    super();
    this.state = {
      // call variable
          ...
          <div class="grid grid-flow-row-dense grid-cols-3 grid-rows-1 mt-8 pb-8">
            <div class="col-span-2 ml-14">
              ...
              <div className="mt-4 text-base font-normal text-gray-400">
                ...
                <a href="/newclassKS" className="mr-5">Terbaru</a>
                <a href="/endclassKs" className="mr-5 text-black">Selesai</a>
                ...
                <div className="bg-white p-4 rounded-3xl grid grid-cols-4">
                  ...
                  <div className="col-span-3 py-2 px-8">
                    ...
                    <div className="grid grid-cols-4">
                      ...
                      <span className="p-2 rounded-lg bg-teal-100 text-teal-600 text-sm font-medium">Rekayasa Perangkat Lunak</span>
                      </div>
                      <div></div>
