  ...
  return (
    <>
      ...
      <div class="lg:w-96 bg-white rounded-none border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 ">
        ...
        <div class="p-5">
          <a href="#">
            <h5 class="mb-2 text-base font-medium tracking-tight text-gray-900 dark:text-white">4 Gejala Awal Kena Omicron: Jika Anda Mengalami Kedinginan hingga Sakit Tenggorokan, Segera Tes Antigen!</h5>
          </a>
          <p class="mb-3 font-normal text-sm text-gray-700 dark:text-gray-400">Beberapa ahli menyebutkan, susunan genetik Omicron sangat berbeda dibandingkan dengan jenis COVID-19 lainnya dan cenderung lebih ringan daripada varian sebelumnya.</p>
