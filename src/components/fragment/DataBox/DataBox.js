  ...
  return (
    <div class="flex flex-row justify-center p-6 box-border h-32 w-50 ">
      <div>
        ...
        <h5 class="mb-2 text-3xl font-semibold tracking-tight text-black">200+</h5>
      ...
      <div className="ml-8">
        ...
        <h5 class="mb-2 text-3xl font-semibold tracking-tight text-black">30k+</h5>
      ...
      <div className="ml-8">
        ...
        <h5 class="mb-2 text-3xl font-semibold tracking-tight text-black">60k+</h5>
      ...
      <div className="ml-8">
        ...
        <h5 class="mb-2 text-3xl font-semibold tracking-tight text-black">1k+</h5>
        <p class="font-medium text-base text-gray-800">Sertifikasi Online</p>
      </div>
    </div>
  );
}
