        ...
        return(
            <div className="card rounded-3xl bg-white">
                <div className="card-header bg-green-400 rounded-t-3xl p-4 pt-10 text-white">
                    <Link to="/detailKelasGuru" className="text-xl font-medium">Bahasa Inggris</Link>
                ...
                <div>
                    ...
                    <Link to="/detailKelasGuru" className="bg-red-600 rounded-2xl px-3 py-2 text-white right-4 bottom-4 absolute">
                        Lihat Aktivitas
                    </Link>
                </div>
                </div>
