    ...
    <div class="p-6 card bg-white rounded-3xl">
      <div className="grid grid-cols-5 gap-4">
        ...
        <div className="col-span-3">
          ...
          <h6 className="font-normal text-sm text-grey-700 mt-2">
            Rp.8797192379
          </h6>
        ...
        <div>
          ...
          <div className="mt-4">
            ...
            <button className="btn btn-sm bg-red-600 py-2 px-4 rounded-full text-white mt-6 inline text-sm font-medium">
              Detail
            </button>
          </div>
        </div>
